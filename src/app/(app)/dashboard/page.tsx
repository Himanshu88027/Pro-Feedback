...
import { acceptingMessageSchemas } from '@/schemas/acceptMessage'
...
function page() {
  ...
  const form = useForm({
    resolver : zodResolver(acceptingMessageSchemas)
  })
  ...
  const fetchAcceptMessages = useCallback(async () => {
    ...
    try {
      ...
      toast({
        title: 'Error',
        description: axiosError.response?.data.message?? 'An error occurred while fetching accept messages',
        variant: 'destructive',
      })
    } finally {
  ...
  const handleSwitchChange = async () => {
    try {
      ...
      toast({
        title: 'Error',
        description: axiosError.response?.data.message?? 'An error occurred while updating message switch',
        variant: 'destructive',
      })
    }
